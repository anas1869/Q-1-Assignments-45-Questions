"use strict";
// 01
// Node.js , vs Code and typescript are installed on pc
// 02
// let fName = "Eric";
...
// let autherName = "Albert Einstein";
// console.log(famousQuote)
// console.log(autherName)
// 05
// let famous_person = "Albert Einstein";
// let famousQuote = "A Person Who Never Made a Mistake Never Tried Anything New";
// let message_= `${famous_person} once said, "${famousQuote}"`;
...
// 09
// let luckynumber = 22;
// console.log(`${luckynumber} is my one of the favorite and lucky number `);
// 10
//      adding comments
// 02
// let fName = "Eric";
...
// console.log(titlecase("personName"));
// 11
// let namesArr = ["Ahmad","Anas","Talha","Taha"];
// console.log(namesArr);
// 12
// let friendsArr = ["Ahmad","Anas","Talha","Taha"];
// for (let i = 0;i < friendsArr.length;i++){
//     console.log(`Hello My Friend ${friendsArr[i]}, How Are You?`);
// }
// 13
...
// }
// 14
// let guestsListArray=["all best friends" , "cousins" , "neighbours"];
// for (let i = 0; i < guestsListArray.length; i++) {
//     console.log(`Dear ${guestsListArray[i]}. I Am Inviting You To On a Dinner At My Home.`);
// }
// 15
// const guestsListArray=["all best friends" , "cousins" , "neighbours"];
// const not_Coming="best friend Ismail";
// const coming_Guest="another friend Ismail";
// for (let i = 0; i < guestsListArray.length; i++) {
